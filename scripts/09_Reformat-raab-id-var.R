...
# for (df in c("raabs_612", "raabs_618", "raabs_pop_612", "raabs_pop_618", "raabs_pop_612_repo", "raabs_pop_618_repo"))
  for (df in c("raabs_612", "raabs_618", "raabs_pop_612_repo", "raabs_pop_618_repo"))
...
data.frames <- list(raabs_612, raabs_618, raabs_pop_612_repo, raabs_pop_618_repo)
names(data.frames) <- c("raabs_612", "raabs_618", "raabs_pop_612_repo", "raabs_pop_618_repo")
